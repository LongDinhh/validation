 ...
 * @subpackage Coccoc\Validation\Rules\Behaviours\CanValidateFiles
 */
trait CanValidateFiles
{
    /**
     ...
     * @return bool
     */
    protected function isValueFromUploadedFiles($value): bool
    {
        if (!is_array($value)) {
            return false;
        }
     ...
     * @return array|null
     */
    protected function resolveUploadedFileValue($value): ?array
    {
